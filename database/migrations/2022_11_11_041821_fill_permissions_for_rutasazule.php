...
class FillPermissionsForRutasazule extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRutasazule constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.rutasazule',
            'admin.rutasazule.index',
            'admin.rutasazule.create',
            'admin.rutasazule.show',
            'admin.rutasazule.edit',
            'admin.rutasazule.delete',
            'admin.rutasazule.bulk-delete',
        ]);
