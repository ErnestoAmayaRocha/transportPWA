...
class FillPermissionsForRutasblanca extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRutasblanca constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.rutasblanca',
            'admin.rutasblanca.index',
            'admin.rutasblanca.create',
            'admin.rutasblanca.show',
            'admin.rutasblanca.edit',
            'admin.rutasblanca.delete',
            'admin.rutasblanca.bulk-delete',
        ]);
