...
class FillPermissionsForRutasamarilla extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRutasamarilla constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.rutasamarilla',
            'admin.rutasamarilla.index',
            'admin.rutasamarilla.create',
            'admin.rutasamarilla.show',
            'admin.rutasamarilla.edit',
            'admin.rutasamarilla.delete',
            'admin.rutasamarilla.bulk-delete',
        ]);
