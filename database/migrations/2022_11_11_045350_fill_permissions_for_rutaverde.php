...
class FillPermissionsForRutaverde extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRutaverde constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.rutaverde',
            'admin.rutaverde.index',
            'admin.rutaverde.create',
            'admin.rutaverde.show',
            'admin.rutaverde.edit',
            'admin.rutaverde.delete',
            'admin.rutaverde.bulk-delete',
        ]);
