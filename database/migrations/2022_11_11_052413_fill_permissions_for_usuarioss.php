...
class FillPermissionsForUsuarioss extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUsuarioss constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.usuarioss',
            'admin.usuarioss.index',
            'admin.usuarioss.create',
            'admin.usuarioss.show',
            'admin.usuarioss.edit',
            'admin.usuarioss.delete',
            'admin.usuarioss.bulk-delete',
        ]);
