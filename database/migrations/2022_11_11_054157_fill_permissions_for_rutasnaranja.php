...
class FillPermissionsForRutasnaranja extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRutasnaranja constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.rutasnaranja',
            'admin.rutasnaranja.index',
            'admin.rutasnaranja.create',
            'admin.rutasnaranja.show',
            'admin.rutasnaranja.edit',
            'admin.rutasnaranja.delete',
            'admin.rutasnaranja.bulk-delete',
        ]);
