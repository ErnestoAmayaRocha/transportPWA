...
class FillPermissionsForRutasnaranjass extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRutasnaranjass constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.rutasnaranjass',
            'admin.rutasnaranjass.index',
            'admin.rutasnaranjass.create',
            'admin.rutasnaranjass.show',
            'admin.rutasnaranjass.edit',
            'admin.rutasnaranjass.delete',
            'admin.rutasnaranjass.bulk-delete',
        ]);
