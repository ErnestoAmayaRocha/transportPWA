...
class FillPermissionsForRutasroja extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRutasroja constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.rutasroja',
            'admin.rutasroja.index',
            'admin.rutasroja.create',
            'admin.rutasroja.show',
            'admin.rutasroja.edit',
            'admin.rutasroja.delete',
            'admin.rutasroja.bulk-delete',
        ]);
