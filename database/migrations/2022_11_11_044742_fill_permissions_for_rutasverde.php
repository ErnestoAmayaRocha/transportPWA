...
class FillPermissionsForRutasverde extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRutasverde constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.rutasverde',
            'admin.rutasverde.index',
            'admin.rutasverde.create',
            'admin.rutasverde.show',
            'admin.rutasverde.edit',
            'admin.rutasverde.delete',
            'admin.rutasverde.bulk-delete',
        ]);
